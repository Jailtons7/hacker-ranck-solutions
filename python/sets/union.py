...
The same student could be in both sets. Your task is to find the total number of students who have
...
def get_total_students(english: Set[int], french: Set[int]) -> int:
...
if __name__ == '__main__':
    ...
    print(get_total_students(english_students, french_students))
