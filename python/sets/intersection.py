...
def get_total_english_and_frensh_subscribers(english: Set[int], frensh: Set[int]) -> int:
    return len(english.intersection(frensh))
...
if __name__ == '__main__':
    ...
    print(get_total_english_and_frensh_subscribers(english_subscribers, french_subscribers))
